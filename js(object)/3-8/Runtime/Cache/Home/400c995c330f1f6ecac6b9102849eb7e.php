...
<p>欢迎<?php echo (session('username')); ?>登录&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/js(object)/3-8/index.php/Home/Index/find/">您有<?php echo ($num); ?>条信息</a></p>
<a href="/js(object)/3-8/index.php/Home/Index/login_out/">退出</a>
<form action="/js(object)/3-8/index.php/Home/Index/add/" method="post">
    <table>
        <tr>
            <td>接收人</td>
            <td>
